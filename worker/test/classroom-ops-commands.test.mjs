...
try {
  ...
  await check('AT-33 slice: fresh schema.sql equals the previous schema plus migrations 0011–0014; all re-runnable and additive', async () => {
    ...
    const m = ['0011-classroom-ops', '0012-classroom-ops-commands', '0013-classroom-ops-control', '0014-classroom-ops-evidence-review'].map((n) => readFileSync(new URL(`../migrations/${n}.sql`, import.meta.url), 'utf8'));
