...
if(modelMode && (codexMode || effortRun)) throw Error('choose one rehearsal backend');
...
let modelDb;
if(modelMode){
 modelDb=new DatabaseSync(':memory:');modelDb.exec(readFileSync(new URL('../migrations/0006-model-usage.sql',import.meta.url),'utf8'));
