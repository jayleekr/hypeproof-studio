...
-- ── migrations/0026-authoring-rehearsal.sql (Chalk authoring rehearsal and confirmation, #1012 · #751 G2) ──
-- A learner-condition rehearsal of one frozen candidate version, the model requests made with its code, and the
-- instructor's confirmation of exactly that candidate. Identifiers, hashes, tool names and reason codes only.
