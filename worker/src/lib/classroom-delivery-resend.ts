...
export const EMAIL_TEMPLATES: Record<string, { subject: string; text: (link: string) => string; html: (link: string) => string }> = {
  'report-link-ko-1': {
    ...
    text: (link) => `안녕하세요.\n\n이번 수업에서 관찰된 내용을 강사가 확인해 보고서로 정리했습니다. 점수나 순위가 아니라, 수업 중 실제로 관찰된 행동과 그 근거를 적은 것입니다.\n\n보고서 보기: ${link}\n\n이 주소를 가진 사람은 누구나 보고서를 볼 수 있으니 다른 사람에게 전달하지 말아 주세요. 주소는 7일 뒤 닫힙니다. 내용에 고칠 점이 있거나 받고 싶지 않으시면 수업 운영자에게 알려 주세요.\n\nHypeProof`,
    html: (link) => `<p>안녕하세요.</p><p>이번 수업에서 관찰된 내용을 강사가 확인해 보고서로 정리했습니다. 점수나 순위가 아니라, 수업 중 실제로 관찰된 행동과 그 근거를 적은 것입니다.</p><p><a href="${link}">보고서 보기</a></p><p>이 주소를 가진 사람은 누구나 보고서를 볼 수 있으니 다른 사람에게 전달하지 말아 주세요. 주소는 7일 뒤 닫힙니다. 내용에 고칠 점이 있거나 받고 싶지 않으시면 수업 운영자에게 알려 주세요.</p><p>HypeProof</p>`,
  },
};
