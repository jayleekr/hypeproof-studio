...
export const WORLDS: WorldDef[] = [
  ...
  { id: "kq-run", ...G("찍찍", "🐁", ["생쥐", "쥐", "하수구"]), fill: { TITLE: "찍찍의 캄캄한 하수구", GUEST_EMOJI: "🐁", GUEST_NAME: "찍찍", GUEST_LINE: "하수구가 너무 캄캄해… 웅덩이도 많고, 뒤에서 물이 밀려와. 치즈까지 어떻게 가지…", PLAYER_EMOJI: "🐁", ITEM_A: "🧀", ITEM_B: "💧", SPEED: "6", RATE: "6", GOAL: "60", SPECIAL: "1", BG_TOP: "#111318", BG_BOT: "#23262f" } },
  ...
  { id: "kq-jump", ...G("도토", "🐿️", ["다람쥐", "나무", "도토리"]), fill: { TITLE: "도토의 부러진 나무", GUEST_EMOJI: "🐿️", GUEST_NAME: "도토", GUEST_LINE: "폭풍이 지나가서 나뭇가지가 다 부러졌어… 도토리집은 저 위인데, 밟으면 부러지고 바람에 자꾸 밀려…", PLAYER_EMOJI: "🐿️", ITEM_A: "🌰", ITEM_B: "🍂", SPEED: "6", RATE: "6", GOAL: "30", SPECIAL: "7", BG_TOP: "#3a4a5c", BG_BOT: "#8fa3b3" } },
