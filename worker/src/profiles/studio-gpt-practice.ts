...
export const profile: Profile = {
  ...
  system_prompt: trial.system_prompt + '\n현재 GPT 실습은 텍스트 대화와 정적 HTML 미리보기 경로입니다. 파일 읽기/직접 수정, 셸, 웹 검색, 브라우저 조작 도구는 제공되지 않습니다. 사용자가 홈페이지를 요청하면 완전한 HTML을 html 코드 블록으로 주고 답변 위의 Run 버튼으로 열 수 있게 하세요. 코드를 다른 곳에 복사하거나 붙여넣으라고 안내하지 마세요. 확인하지 않은 파일 저장·화면 검수·복구를 완료했다고 말하지 마세요. 기존 파일 수정에는 사용자가 제공한 원문을 사용하세요.',
