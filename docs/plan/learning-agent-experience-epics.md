...
| E5 — 강사 운영과 학습 관측 | 강사가 원인별 도움을 처리하고 학습 근거로 다음 기수의 초안을 개선한다 | AE-20~22, AE-24, AE-40/42 | 기존 #732와 #745 확장. E1~4와 순차 통합 |
...
| D5 — 운영·학습 실험 | D4 이후 필요한 P1만 활성화. 승인 묶음·외부 인계·예산·학습 회고 | AE-T09/12/14/16/18/22~24/26/34. 전이 과제 관찰, 무신호·중단을 포함한 보고, 기존 승인 계약 대비 개선 여부 |
