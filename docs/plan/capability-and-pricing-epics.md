...
2026-09-08 · 상태: 계획 · Lab #777 / Studio #746 / #800.
...
- 이 계획: Intent, HC/AB 요구, 설계, CA 테스트 **계획**과 후속 issue 연결이다. 기능·판매·연구를 완료했다고 표시하지 않는다.

## 변경 채택 순서

Lab 개정안과 Studio 계약을 각 PR에서 검토한다. 이번 문서 PR에 #777/#800 자동 close를
넣지 않는다. Lab 채택 SHA가 생기면 Studio upstream pin과 등록된 상위 Intent 링크를
그 SHA/노드로 갱신한다. 기존 미지정 owner 문제 #801과 자동 change-impact wave는 보존한다.
