...
철학 연결은 [2026-09-08 개정 적용](../../design/philosophy-alignment-2026-09-08.md)을 따른다.
...
두 결과 모두 보류하거나 사람의 반론을 요청할 수 있다. 여러 모델의 의견과 인간의 social correction은
별도 관측이며 서로 대체하지 않는다. 도구 숙련/제작 성과와 판단의 성장·유지도 분리한다.
