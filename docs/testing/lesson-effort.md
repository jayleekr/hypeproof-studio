...
Chromium), EFF-T02D local workerd/D1 PASS. EFF-T05 PASS: 9개 모델, SDK 22건·proxy 11건과 구형 v0.1.56 2건의 실제 API 요청, 고정 수업과 390/1280px·키보드·200% 입력 접근까지 대조했다. [원본 결과·스크린샷·실패 이력](../research/agent-experience-acceptance-2026-09-08/course-effort/README.md)을 보존한다. main #829 통합 후 같은 35건을 다시 실행해 통과했다. Windows 실제 기기,
