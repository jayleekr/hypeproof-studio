...
| 대상별 결과와 재선택 | 선택 좌석마다 회수 상태 + 요청의 원장 상태(서버 접수·배정은 ‘기기 수신 확인 전’, 기기 receipt 뒤에만 ‘수신’) + 제외/실패/미확인 사유. ‘도착하지 않은 대상만 다시 선택’은 미연결·불완전·요청 실패/만료/미확인만 고르고 제외(동의 없음·철회)나 전체를 고르지 않는다 | AT-37 |
